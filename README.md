...
**Product:** Technical strategy, market research, user research, risk management, resource allocation, feature prioritization, roadmap planning, agile methodologies, project management tools, product launches, data analysis.

## Tech Experience
**Programming:** Efficiency in React, CSS, Next.js, Python, TypeScript, C#, Swift (medium).

**Engineering:** System design, algorithms & data structures, code quality and review.

**Cloud Platforms & DevOps:** Cloud infrastructure (AWS, Serverless), CI/CD pipelines (GitHub, GitLab).

**Database Management:** Relational databases, NoSQL databases, database design & optimization.

**Testing and Quality Assurance:** Automated testing, performance testing.

**Security and Compliance:** Security practices, compliance & regulations.

**Technical Leadership:** Technical decision making, mentorship, technical debt management.
